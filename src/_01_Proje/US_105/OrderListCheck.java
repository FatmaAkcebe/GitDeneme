...
//2.yol
//        List<WebElement> message=driver.findElements(By.cssSelector("[class='no-record']"));

//mesajın var olup olmadığını doğrula.
//        Assert.assertTrue("Sipariş listesi boş.",!message.isEmpty());
//        BekleKapat();
    }
}